...
//-----------------OLED端口定义----------------  					   
#define SCL  PCout(2)  //接口定义:lcd_sclk就是LCD的SCLK   //SCLK接到“D0”脚
#define SDA   PCout(1)	 //接口定义:lcd_sda就是LCD的SDA	    //SDIN接到“D1”脚
...
void display_number_16x8(u8 page,u8 colum,u16 number);
#endif  
